...
- **Estrategias de compensación híbrida:** Para mitigar el efecto en constelaciones LEO modernas, se implementa una arquitectura híbrida:
...
1. **Interferencia electromagnética (EMI) en la aviónica de a bordo:** En altitud o lejos de la infraestructura de tierra, el terminal móvil percibe una señal débil y eleva automáticamente su potencia de transmisión de RF a su límite máximo. Las emisiones de múltiples dispositivos en cabina pueden acoplarse con cableados y sensores no blindados de la aeronave, interfiriendo con receptores GPS, radioaltímetros de precisión y sistemas de radiocomunicación en banda VHF aeronáutica utilizados críticamente en maniobras de despegue y aproximación.
...
**[1]** Satcom Index, *Satellite Doppler Shift Explained: Why Frequency Changes in LEO Satellite Communication*, Engineering Guide, 2024.
